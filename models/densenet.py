# Code source: https://github.com/gpleiss/efficient_densenet_pytorch
...
__all__ = ['DenseNet', 'densenet_cifar', 'densenet121']
...
def densenet_cifar(pretrained=False, **kwargs):
    model = DenseNet(num_init_features=24, growth_rate=12, block_config=(16, 16, 16), **kwargs)
    return model
